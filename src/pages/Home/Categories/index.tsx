  ...
  return (
    <>
      <div className="hidden sm:block sidebar border-r-2 pt-6 pl-10 border-gray-200">
        <ul className="flex lg:w-2/3 mx-auto flex-col">
        ...
        <div className="sidebar_link flex items-center sidebar_link lg:w-3/4 xl:w-2/3 my-2 mx-auto">
          <p className="mx-1 xl:mr-2 xl:ml-0">View all categories</p>
          <ArrowForwardIosIcon />
        </div>
      </div>
